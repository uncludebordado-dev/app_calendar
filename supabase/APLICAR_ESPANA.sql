...
-- Panel + zona horaria España + rediseño (avatar, notificaciones, chat).
-- =============================================================================

-- ===== PARTE 1: PANEL (pagos, asistencias, fecha de nacimiento, cumpleaños) =====
...
-- ===== PARTE 3: REDISEÑO (avatar, preferencia de notificaciones, aviso de alta, chat) =====
